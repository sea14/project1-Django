# Django settings for bball project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_PATH, 'bball.db'),                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'bball.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bball.wsgi.application'
